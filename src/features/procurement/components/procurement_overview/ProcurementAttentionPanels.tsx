...
const SkeletonMetric: React.FC = () => (
  <div className="procurement-overview-attention-skeleton" aria-label="Loading">
    <span className="procurement-skeleton procurement-skeleton--value" />
    <span className="procurement-skeleton procurement-skeleton--text" />
  </div>
);
