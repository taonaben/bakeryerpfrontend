...
import type { PurchaseOrderStatus } from '../types/purchase_orders_models';
...
interface PurchaseOrderFiltersState {
  filters: PurchaseOrderFilters;
  setFilter: (key: keyof PurchaseOrderFilters, value: any) => void;
  setFilters: (partial: Partial<PurchaseOrderFilters>) => void;
...
const usePurchaseOrderFilters = create<PurchaseOrderFiltersState>()(
  devtools(
    immer((set, get) => ({
