...
export const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    path: "/sales",
    icon: ShoppingCart,
    roles: ["sales_rep", "manager", "owner_director"],
...
/**
 * USER ADMIN ITEM (Separate as it appears at bottom)
 */
export const userManagementItem: NavigationItem = {
  ...
  path: "/users",
  icon: Users,
  roles: ["manager", "owner_director"],
  isActive: (pathname) =>
    pathname.startsWith("/users") || pathname.startsWith("/employees"),
};
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Tag,
            isActive: (pathname) =>
              pathname.startsWith("/procurement/supplier-products"),
          },
        ],
      },
    ],
        ...
        items: [
          {
            ...
            icon: ListOrdered,
            isActive: (pathname) =>
              pathname.startsWith("/production/planned-orders"),
          },
          // {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: BookOpen,
            isActive: (pathname) =>
              pathname.startsWith("/costing/standard-costs"),
          },
          {
            id: "overhead-rates",
            ...
            icon: Percent,
            isActive: (pathname) =>
              pathname.startsWith("/costing/overhead-rates"),
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            icon: Package,
            isActive: (pathname) =>
              pathname.startsWith("/costing/product-costing"),
          },
          {
            id: "pricing-rules",
            ...
            icon: Tag,
            isActive: (pathname) =>
              pathname.startsWith("/costing/pricing-rules"),
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            icon: TrendingUp,
            isActive: (pathname) =>
              pathname.startsWith("/costing/variance-analysis"),
          },
          {
            id: "costing-reports",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: FileText,
            isActive: (pathname) =>
              pathname.startsWith("/sales/price-agreements"),
          },
        ],
      },
      {
 ...
 */
export const getModuleSidebarConfig = (
  moduleId: string,
): ModuleSidebarConfig | null => {
