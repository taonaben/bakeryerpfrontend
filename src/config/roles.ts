...
export const ROLE_CONFIGS: Record<UserRole, RoleConfig> = {
  ...
  planner: {
    ...
    navigationAccess: ['dashboard', 'production', 'inventory', 'procurement', 'finance', 'reports'],
    canViewReports: true,
    canExportData: true,
    canEditMasterData: true,
    canApproveTransactions: true,
  ...
  purchasing_officer: {
    ...
    navigationAccess: ['dashboard', 'procurement', 'finance', 'inventory', 'reports'],
    canViewReports: true,
    canExportData: true,
    canEditMasterData: true,
    canApproveTransactions: true,
  ...
  accountant: {
    ...
    navigationAccess: ['dashboard', 'finance', 'reports'],
    canViewReports: true,
    canExportData: true,
    canEditMasterData: true,
    canApproveTransactions: false,
  ...
  manager: {
    ...
    navigationAccess: ['dashboard', 'inventory', 'production', 'procurement', 'finance', 'sales', 'reports'],
    canViewReports: true,
    canExportData: true,
    canEditMasterData: true,
    canApproveTransactions: true,
  ...
  owner_director: {
    ...
    navigationAccess: ['dashboard', 'inventory', 'production', 'procurement', 'finance', 'sales', 'reports', 'settings'],
    canViewReports: true,
    canExportData: true,
    canEditMasterData: true,
    canApproveTransactions: true,
